...
class Hybrid_search():
    ...
    def query_hybrid_search(self, query, metadata_filter=None, limit=5):
        ...
        # print(f"Query results: {documents}")  # 검색 결과 확인
...
if __name__ == '__main__':
    ...
    query = "What is the thermal conductivity of Glass Fiber Type Gr2 at an average temperature of 204℃?"
    ...
    if results:
        ...
        # print(f"Reranked Documents: {reranked_documents}")  # 리랭킹 결과 확인
    else:
