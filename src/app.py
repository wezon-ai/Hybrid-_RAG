...
# # 세션 상태를 출력하여 메시지 기록이 잘 저장되고 있는지 확인
...
#         st.write("Generated prompt:", prompt)  # 프롬프트 로그 출력

#         # 쿼리 엔진 실행 후 응답 출력
#         response = create_query_engine(prompt)
#         st.write("Query engine response:", response)  # 응답 로그 출력
...
# Title
st.set_page_config(page_title="Hybrid RAG with Qdrant BM42 & Mistral", layout="wide")
st.title("Hybrid RAG with Qdrant BM42 & ADA-002")
